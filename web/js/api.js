...
(function (global) {
  ...
  var api = {
    ...
    kyc: function () { return request('GET', '/api/kyc'); },
    kycProfile: function (b) { return request('POST', '/api/kyc/profile', b); },
    kycAddPerson: function (b) { return request('POST', '/api/kyc/people', b); },
    kycRemovePerson: function (id) { return request('DELETE', '/api/kyc/people/' + id); },
    kycFile: function (b) { return request('POST', '/api/kyc/documents', b); },
    kycRemoveDocument: function (id) { return request('DELETE', '/api/kyc/documents/' + id); },
    kycDownload: function (id) { return request('GET', '/api/kyc/documents/' + id + '/file'); },
    kycSubmit: function () { return request('POST', '/api/kyc/submit', {}); },
    kycQueue: function () { return request('GET', '/api/ops/kyc'); },
    kycApplicant: function (id) { return request('GET', '/api/ops/kyc/' + id); },
    kycDecide: function (id, b) { return request('POST', '/api/ops/kyc/' + id + '/decision', b); },

    agreements: function () { return request('GET', '/api/agreements'); },
    agreement: function (ref) { return request('GET', '/api/agreements/' + ref); },
    agreementTemplates: function () { return request('GET', '/api/ops/agreement-templates'); },
    ...
    markPaidQuote:  function (ref, b) { return request('POST', '/api/ops/quotes/' + ref + '/mark-paid', b || {}); },
    tickCondition:  function (ref, b) { return request('POST', '/api/ops/quotes/' + ref + '/condition', b); },
    releaseReservations: function () { return request('POST', '/api/ops/reservations/release', {}); },
    ...
    pingQuote:    function (t, b) { return request('POST', '/api/quote/' + t + '/ping', b); },
    quoteDownloaded: function (t, b) { return request('POST', '/api/quote/' + t + '/downloaded', b); },
